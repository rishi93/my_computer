...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Hack Assembler - Converts Hack assembly (.asm) files to binary (.bin)"
    )
    parser.add_argument(
        "-i", "--input",
        type=str,
        help="Input assembly file to assemble"
    )
    parser.add_argument(
        "-o", "--output",
        type=str,
        help="Output binary file (default: input file with .bin extension)"
    )
